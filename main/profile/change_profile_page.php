...
if (isset($_GET['view']) && $_GET['view'] == $_SESSION['user']) {
    echo <<<_FORM
                    <form action="profile.php?r=$randstr&view=$user" method="POST" enctype='multipart/form-data'>
                        <h5 style="text-align: center">Enter or edit your details and/or upload an image</h5>
                        <div class="about-me">
                            <span>About me: </span>
                            <textarea style="width: 100%;" spellcheck="false" rows="7" cols="50" name='text'>$text</textarea><br>
                        </div>
                        <div>
