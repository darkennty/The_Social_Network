...
if ($result->rowCount() != 0) {
    ...
    $src = file_exists("avatars/photo_$profile_user.jpg") ? "avatars/photo_$profile_user.jpg" : "no_photo.jpg";
    ...
    echo "<div class='centered-text'><p>No such blud in our social network! Sorry.</p></div>";
}
